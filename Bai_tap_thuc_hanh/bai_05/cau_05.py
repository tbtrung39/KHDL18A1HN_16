# Đọc file Sbd_Ph.dat
sbd_phach = {}
with open(r"Bai_tap_thuc_hanh\bai_05\Sbd_Ph.dat", "r") as f:
    for line in f:
        if line.strip() == "":
            continue
...
sbd_ten = {}
with open(r"Bai_tap_thuc_hanh\bai_05\SBD_Ten.txt", "r") as f:
    for line in f:
...
ds_thi_sinh = []
with open(r"Bai_tap_thuc_hanh\bai_05\Phieu_Diem.txt", "r") as f:
    for line in f:
