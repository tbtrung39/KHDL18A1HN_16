...
filename1=read_sbd_phach(input('nhập đường dẫn đến file nội dung muốn đọc nội dung gồm Sbd và số phách : filename1= '))
filename2=read_sbd_ten(input('nhập đường dẫn đến file nội dung muốn đọc nội dung gồm Sbd và tên : filename2= '))
filename3=read_phach_diem(input('nhập đường dẫn đến file nội dung muốn đọc nội dung gồm số phách và điểm : filename3= '))
# Ghép thông tin
thi_sinh = []
